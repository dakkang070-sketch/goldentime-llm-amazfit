            ...
            children: [u.jsxs("header", {
                ...
                children: se && u.jsxs(u.Fragment, {
                    children: [u.jsx(st.button, {
                        ...
                        children: [u.jsxs("div", {
                            className: "w-full rounded-[28px] border border-orange-100 bg-white px-5 pb-6 pt-5 shadow-[0_16px_48px_rgba(15,23,42,0.18)]",
                            style: {
                                maxWidth: "312px",
                                borderRadius: "28px"
                            },
                ...
                children: Ne && u.jsxs(u.Fragment, {
                    children: [u.jsx(st.button, {
                        ...
                        className: "fixed inset-0 z-50 flex items-center justify-center p-4",
                        children: [u.jsxs("div", {
                            className: "relative max-h-[80vh] w-full overflow-auto rounded-[28px] bg-white p-6 shadow-2xl",
                            style: {
                                maxWidth: "480px",
                                borderRadius: "28px"
                            },
