...
const MOCK_MEMBERS_HISTORY = [
  { id: 'm-101', name: '김철수', email: 'kim.cs@example.com', phone: '010-1234-5678', age: 78, gender: '남', address: '서울 종로구 사직로8길 42', riskLevel: '고위험', incidentCount: 3, lastIncidentDate: '2023-10-25' },
  { id: 'm-104', name: '최지우', email: 'jw.choi@example.com', phone: '010-9876-5432', age: 74, gender: '여', address: '서울 강남구 도산대로45길 18', riskLevel: '고위험', incidentCount: 5, lastIncidentDate: '2023-10-28' },
  { id: 'm-105', name: '정우성', email: 'ws.jung@example.com', phone: '010-3333-7777', age: 70, gender: '남', address: '대구 수성구 달구벌대로 2450', riskLevel: '중위험', incidentCount: 2, lastIncidentDate: '2023-10-20' },
  { id: 'm-102', name: '박영자', email: 'yj.park@example.com', phone: '010-5555-4444', age: 82, gender: '여', address: '부산 해운대구 센텀중앙로 78', riskLevel: '중위험', incidentCount: 1, lastIncidentDate: '2023-09-15' },
];

const MOCK_INCIDENTS: Record<string, Incident[]> = {
  'm-101': [
    {
      id: 'inc-101-1', memberId: 'm-101', memberName: '김철수', timestamp: '2023-10-25 14:30', type: '낙상 감지', severity: '위험', status: '완료',
      location: { lat: 37.57602, lng: 126.97683, address: '서울 종로구 사직로8길 42 (자택 거실)' }, aiConfidence: 98, aiAnalysis: '강한 충격 후 움직임 없음 감지. 의식 확인 필요.',
      heartRate: 115,
      biometricsSnapshot: { 
        heartRate: 115, bloodPressure: '150/90', bloodOxygen: 96, temperature: 36.8,
        sleep: 5.2, bloodGlucose: 140, stress: 85, hrv: 30, ecg: '비정상', gyroscope: '낙상 감지'
      },
      deviceSnapshot: { 
    ...
    {
      id: 'inc-101-2', memberId: 'm-101', memberName: '김철수', timestamp: '2023-10-10 09:15', type: '심박 이상', severity: '주의', status: '완료',
      location: { lat: 37.57602, lng: 126.97683, address: '서울 종로구 사직로8길 42 (자택 침실)' }, aiConfidence: 85, aiAnalysis: '일시적인 빈맥(110bpm) 5분간 지속 후 정상화.',
      heartRate: 110,
      biometricsSnapshot: { 
        heartRate: 110, bloodPressure: '145/88', bloodOxygen: 97, temperature: 36.5,
        sleep: 6.5, bloodGlucose: 110, stress: 60, hrv: 45, ecg: '비정상', gyroscope: '안정'
      },
      deviceSnapshot: { 
        modelName: 'STARMAX WATCH ULTRA G1', 
        modelNumber: 'SMX-UG1',
     ...
     {
      id: 'inc-101-3', memberId: 'm-101', memberName: '김철수', timestamp: '2023-09-05 18:20', type: 'SOS 호출', severity: '위험', status: '완료',
      location: { lat: 37.57450, lng: 126.96501, address: '서울 종로구 사직공원길 15 (산책로)' }, aiConfidence: 100, aiAnalysis: '사용자 수동 SOS 버튼 호출.',
      heartRate: 98,
      biometricsSnapshot: { 
        heartRate: 98, bloodPressure: '130/85', bloodOxygen: 98, temperature: 37.0,
        sleep: 7.0, bloodGlucose: 95, stress: 40, hrv: 55, ecg: '정상', gyroscope: '활발함'
      },
      deviceSnapshot: { 
        modelName: 'STARMAX WATCH ULTRA G1', 
        modelNumber: 'SMX-UG1',
  ...
  'm-102': [
     {
      id: 'inc-102-1', memberId: 'm-102', memberName: '박영자', timestamp: '2023-09-15 11:00', type: '안심존 이탈', severity: '주의', status: '완료',
      location: { lat: 35.11502, lng: 129.04144, address: '부산 동구 중앙대로 206 (부산역 광장)' }, aiConfidence: 92, aiAnalysis: '설정된 활동 반경(1km) 이탈 감지.',
      heartRate: 88,
      biometricsSnapshot: { 
        heartRate: 88, bloodPressure: '120/80', bloodOxygen: 99, temperature: 36.6,
        sleep: 6.0, bloodGlucose: 105, stress: 30, hrv: 60, ecg: '정상', gyroscope: '활발함'
      },
      deviceSnapshot: { 
        modelName: 'STARMAX BAND S2', 
        modelNumber: 'SMX-BS2',
        manufacturer: 'STARMAX',
  ...
  'm-104': [
     {
      id: 'inc-104-1', memberId: 'm-104', memberName: '최지우', timestamp: '2023-10-28 23:40', type: '미활동', severity: '주의', status: '처리 중',
      location: { lat: 37.52501, lng: 127.03705, address: '서울 강남구 도산대로45길 18 (자택)' }, aiConfidence: 75, aiAnalysis: '24시간 동안 유의미한 움직임 미감지.',
      heartRate: 65,
      biometricsSnapshot: { 
        heartRate: 65, bloodPressure: '110/70', bloodOxygen: 98, temperature: 36.5,
        sleep: 5.5, bloodGlucose: 100, stress: 20, hrv: 50, ecg: '정상', gyroscope: '안정'
      },
      deviceSnapshot: { 
        modelName: 'STARMAX WATCH 4', 
        modelNumber: 'SMX-W4',
        manufacturer: 'STARMAX',
    ...
    {
      id: 'inc-104-2', memberId: 'm-104', memberName: '최지우', timestamp: '2023-10-20 08:00', type: '심박 이상', severity: '위험', status: '완료',
      location: { lat: 37.49255, lng: 127.04652, address: '서울 강남구 언주로 211 (강남세브란스병원)' }, aiConfidence: 95, aiAnalysis: '서맥(40bpm) 지속 감지.',
      heartRate: 40,
      biometricsSnapshot: { 
        heartRate: 40, bloodPressure: '90/60', bloodOxygen: 94, temperature: 36.2,
        sleep: 4.0, bloodGlucose: 85, stress: 70, hrv: 25, ecg: '비정상', gyroscope: '안정'
      },
      deviceSnapshot: { 
        modelName: 'STARMAX WATCH 4', 
        modelNumber: 'SMX-W4',
    ...
    {
      id: 'inc-104-3', memberId: 'm-104', memberName: '최지우', timestamp: '2023-10-15 14:00', type: '낙상 감지', severity: '주의', status: '오작동',
      location: { lat: 37.52501, lng: 127.03705, address: '서울 강남구 도산대로45길 18 (자택)' }, aiConfidence: 45, aiAnalysis: '기기 낙하로 인한 충격으로 추정.',
      heartRate: 72,
      biometricsSnapshot: { 
        heartRate: 72, bloodPressure: '115/75', bloodOxygen: 98, temperature: 36.7,
        sleep: 6.0, bloodGlucose: 102, stress: 45, hrv: 52, ecg: '정상', gyroscope: '낙상 감지'
      },
      deviceSnapshot: { 
        modelName: 'STARMAX WATCH 4', 
        modelNumber: 'SMX-W4',
        manufacturer: 'STARMAX',
        firmwareVersion: '2.9.8',
        batteryLevel: 22 
      }
    }
  ],
  'm-105': [
    {
      id: 'inc-105-1', memberId: 'm-105', memberName: '정우성', timestamp: '2023-10-20 19:00', type: '심박 이상', severity: '주의', status: '완료',
      location: { lat: 35.82855, lng: 128.61705, address: '대구 수성구 용학로 35-5 (수성못 유원지)' }, aiConfidence: 88,
      heartRate: 135,
      biometricsSnapshot: { 
        heartRate: 135, bloodPressure: '140/90', bloodOxygen: 96, temperature: 37.1,
        sleep: 5.8, bloodGlucose: 130, stress: 80, hrv: 35, ecg: '비정상', gyroscope: '활발함'
      },
      deviceSnapshot: { 
        modelName: 'STARMAX WATCH ULTRA G1', 
        modelNumber: 'SMX-UG1',
    ...
    {
      id: 'inc-105-2', memberId: 'm-105', memberName: '정우성', timestamp: '2023-10-01 07:30', type: '미활동', severity: '정보', status: '완료',
      location: { lat: 35.85901, lng: 128.62505, address: '대구 수성구 달구벌대로 2450 (자택)' }, aiConfidence: 60,
      heartRate: 68,
      biometricsSnapshot: { 
        heartRate: 68, bloodPressure: '118/78', bloodOxygen: 99, temperature: 36.5,
        sleep: 7.5, bloodGlucose: 98, stress: 25, hrv: 65, ecg: '정상', gyroscope: '안정'
      },
      deviceSnapshot: { 
        modelName: 'STARMAX WATCH ULTRA G1', 
        modelNumber: 'SMX-UG1',
...
export const History: React.FC = () => {
  ...
  const filteredMembers = MOCK_MEMBERS_HISTORY.filter(m => 
  ...
  const selectedMember = MOCK_MEMBERS_HISTORY.find(m => m.id === selectedMemberId);
  const allIncidents = selectedMemberId ? MOCK_INCIDENTS[selectedMemberId] || [] : [];

  // Filter incidents by date range
  const incidents = allIncidents.filter(incident => {
    if (!startDate && !endDate) return true;
    
    // Convert "2023-10-25 14:30" to "2023-10-25" for comparison
          ...
          {filteredMembers.map(member => (
            ...
            >
              <div className="flex justify-between items-start mb-1">
                ...
                <span className="text-[13px] text-black">{member.lastIncidentDate}</span>
              </div>
              <div className="flex items-center gap-2 mb-2 flex-wrap">
                 <span className="text-[13px] text-black">ID: {member.id}</span>
