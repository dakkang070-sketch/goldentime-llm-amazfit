  ...
  analysisResult: {
    category: {
      ...
      enum: [
        ...
        "언어 폭력",
        "협박 및 강요",
        "언어 폭력 및 강요", // Added composite category
        "금품 갈취 및 협박", // Added composite category
        "신체 폭력 및 위협", // Added composite category
        "긴급 구조 요청", // Emergency Rescue
        "강요 의심", // Coercion Suspected
        "장난 (과격한 표현)", // Prank (Rough)
        "일상 대화",
        "따돌림", // Bullying
        "장난", // Prank
        "위협", // Intimidation
