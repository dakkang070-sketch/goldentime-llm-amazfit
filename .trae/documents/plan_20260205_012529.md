...
*   **센서 퓨전 및 임계치 제어 (Sensor Fusion & Threshold Control)**
    ...
    *   **Dynamic Thresholds**:
        ...
        *   **Signal Quality Check**: SNR 10dB 미만 또는 Artifact 비율 10% 초과 시 데이터 자동 기각 (False Alarm 방지)
...
---
**작성자 주**: 위 내용은 현재 코드베이스(`RealtimeBiosignalEngine.js`, `geminiService.ts`, `CrimeMap.tsx` 등)의 실제 구현 내용을 기반으로 기술적으로 상세화하여 작성되었습니다. 기술보증기금 제출 양식에 맞게 바로 복사하여 사용하실 수 있습니다.